...
CREATE TABLE ACN_PRN (
    ...
    CUSTOMSEGMENTSTRING 			nvarchar (255) NULL ,
    ...
    DIMENSIONSFONTNAME 				nvarchar (255) NULL ,
    ...
    FILENAMEFONTNAME 				nvarchar (255) NULL ,
    ...
    OUTPUTDESIGNERTEMPLATEFILENAME 	nvarchar (255) NULL ,
    ...
    SEGMENTDESCRIPTIONFONTNAME 		nvarchar (255) NULL ,
	...
	LEGENDFONTNAME 					nvarchar (255) NULL ,
	...
	NOTESFONTNAME 					nvarchar (255) NULL ,
	NOTESFONTSIZE 					smallint NULL ,
	ORIENTATION 					smallint NULL ,
	PRINTLEGEND 					smallint NULL ,
    PRIMARYSHOWFLOOR				smallint NULL ,
    SECONDARYSHOWFLOOR				smallint NULL ,
)
GO
...
CREATE TABLE ACN_POSITION (
	...
	CONTAINERPOSITIONID nvarchar (255) NULL ,
...
CREATE TABLE ACN_T_PRODUCT (
    ...
    MANUFACTURER 		nvarchar (255) NULL ,
    CATEGORY 			nvarchar (255) NULL ,
    DESC_A 				nvarchar (255) NULL ,
    DESC_B 				nvarchar (255) NULL ,
    DESC_C 				nvarchar (255) NULL ,
    DESC_D 				nvarchar (255) NULL ,
    DESC_E 				nvarchar (255) NULL ,
    DESC_F 				nvarchar (255) NULL ,
    DESC_G 				nvarchar (255) NULL ,
    DESC_H 				nvarchar (255) NULL ,
    DESC_I 				nvarchar (255) NULL ,
    DESC_J 				nvarchar (255) NULL ,
    KEY_VAL				nvarchar (255) NULL ,
    FILL_COLOR 			smallint NULL ,
    ...
    STD_PEG 			nvarchar (255) NULL ,
    FIT_TYPE 			smallint NULL ,
    PREFERRED_FIXEL 	nvarchar (255) NULL ,
...
CREATE TABLE ACN_PRODUCT_PLN (
	...
	LINKPRODUCTID		nvarchar (255) NULL ,
    PRICE 				float NULL ,
    PRICE_2 			float NULL ,
    PRODUCT_ID 			nvarchar (255) NOT NULL ,
